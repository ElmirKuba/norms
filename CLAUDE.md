...
3. **Не накапливать долг** — не откладывать обновление доки на потом. Если сессия заканчивается раньше — сохранить задачи в memory (`/Users/elmirkuba/.claude/projects/-Users-elmirkuba-coding-norms/memory/`).
