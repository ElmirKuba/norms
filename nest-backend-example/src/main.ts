...
const swaggerSetupBeforeStartApp = (app: INestApplication<any>) => {
  ...
  const configDoc = new DocumentBuilder()
    .setTitle('Norms API — бэкенд мессенджера «Нормисы»')
    .setDescription(
      'Описание всех endpoints, с которыми можно взаимодействовать с Backend частью проекта, реализованной средствами Nest.js фреймворка',
    )
