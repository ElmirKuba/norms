...
| **Double Ratchet** | ротация ключей каждые N сообщений внутри зашифрованного канала | утечка одного ключа не раскрывает ни прошлое (forward secrecy), ни будущее (break-in recovery) |
